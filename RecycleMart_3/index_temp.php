    ...
    <a href='index.php?category=$category_id' class='item-choose nav-link text-light '>$category_title</a></li>";
      ...
      <div class="d-flex justify-content-end align-items-center">
        ...
        if (isset($_SESSION['user_username'])) {
          ...
          echo "<p style='color:white; padding-right:5px;'>Welcome, $username</p>";
          echo "<form action='login_re_prince/user_login.php' method='post'><button type='submit' class='btn btn-danger mx-3'>Logout</button></form>";
        } ?>
      </div>
