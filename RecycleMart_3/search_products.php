...
<head>
  ...
  .navbar {
    padding: 5px 20px; /* Padding around the navbar */
    border-radius: 0; /* Remove border-radius if not needed */
  }

  .navbar-toggler-icon {
    color: #fff; /* Color of the toggler icon */
  }

  .navbar-nav .nav-link {
    margin-right: 10px; /* Spacing between nav links */
    font-size: 14px; /* Font size of the nav links */
    padding:2px;
  }
  ...
  .navbar-brand img {
    ...
    margin-right: 10px; /* Spacing between the logo and nav links */
  }

  .form-inline .form-control {
    border-color: #fff; /* Border color of the search input */
    color: #fff; /* Text color of the search input */
  }

  .form-inline .btn {
    background-color: #00a2a7; /* Background color of the search button */
    border-color: #00a2a7; /* Border color of the search button */
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mx-3 mr-auto">
          <li class="nav-item active">
            <a class="nav-link text-white  " href="index.php"><h5>Home </h5><span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="Blog_page.php"><h5>Blogs</h5></a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="contact_us.php"><h5>contact Us</h5></a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-white" href="requestpage.php"><h5>Request</h5></a>
          </li>
    ...
    <a class="dropdown-item" href="#">User-Login</a>
        ...
        <div class="cart">
          <a href="cart.php"> <!-- Assuming cart.php is the page for viewing the shopping cart -->
            <img src="cart.png" alt="Shopping Cart" class="logo " >
          </a>
        </div>
      </div>
    </nav>
