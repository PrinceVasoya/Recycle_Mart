...
<body>
    <h3 class="text-center" style="color: #00262d;"> User List</h3>
          ...
          while ($row_data = mysqli_fetch_assoc($result_users)) {
            ...
            ?>
             <tr class="text-center">
                ...
                <td><a href='admin_index.php?delete_user=<?php echo $user_id ?>' class='text-light'><i class='icon fa-solid fa-trash'></i></a></td>
            </tr>   
         <?php } ?> 
        </tbody>
</body>
